...
export const FloatsAndPositioningExercises = () => {
  return (
    <div className="fapConteiner">
      <div className="fapItem1">
        <p>
      ...
      <div className="fapItem3">
        <p>
          Lorem Ipsum is simply dummy text of the printing and typesetting
          industry.
        </p>
      </div>
      <div className="fapItem4">
        <img src={wolf} alt="snow-wolf" />
        <p>
          Lorem Ipsum is simply dummy text of the printing and typesetting
      ...
      <div className="fapItem5">
        <p>zapisz</p>
        <p>na później</p>
      </div>
      <div className="fapItem6">
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Nibh
          mauris cursus mattis molestie a iaculis at. Dictum varius duis at
      ...
      <div className="fapItem7">
        <p>zapisz na poźniej</p>
      </div>
      <div className="fapItem8">
        <p>
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do
          eiusmod tempor incididunt ut labore et dolore magna aliqua. Nibh
          mauris cursus mattis molestie a iaculis at. Dictum varius duis at
      ...
      <div className="fapItem9">
        <div className="fapLightGray" />
        <div className="fapGray" />
        <div className="fapDarkGray" />
      </div>
    </div>
  );
};
